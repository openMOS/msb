...
public class StringMessageDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements StringMessageDataReader {

    private long copyCache;
    private StringMessageTypeSupport typeSupport;

    public StringMessageDataReaderImpl(MSB2ADAPTER.StringMessageTypeSupport ts) {
        typeSupport = ts;
    ...
    synchronized protected DDS.DataReaderView create_dataview() {
        return new StringMessageDataReaderViewImpl(typeSupport);
    }
}
