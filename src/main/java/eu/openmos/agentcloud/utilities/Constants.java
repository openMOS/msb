...
public class Constants {
    ...
    /**
     * Name of the property into the default.properties file that define the
     * host where the agent cloud jade platform is running. Example:
     * openmos.agentplatform.host=localhost
     */
    public static final String PLATFORM_HOST_PARAMETER = "openmos.agentplatform.host";

    /**
     * Name of the property into the default.properties file that define the
     * port number where the agent cloud jade platform is listening. Example:
     * openmos.agentplatform.port=1099
     */
    public static final String PLATFORM_PORT_PARAMETER = "openmos.agentplatform.port";

    /**
     * Name of the property into the default.properties file that define the
     * name of the agent that starts the platform. Example:
     * openmos.agentplatform.name=openmosPlatformStarter
     */
    public static final String PLATFORM_NAME_PARAMETER = "openmos.agentplatform.name";

    /**
     * Name of the property into the default.properties file that define the
     * current version of the agent-cloud platform. Example:
     * openmos.agentplatform.release=0.0.1
     */
    public static final String PLATFORM_RELEASE_PARAMETER = "openmos.agentplatform.release";

    /**
     * Name of the property into the default.properties file that define if the
     * Jade graphical console has to be started or not. Default value is false.
    ...
    /**
     * Name of the property into the default.properties file that define the
     * port number where the agent cloud bootstrap class is listening for
     * shutdown messages. Example: openmos.agentplatform.shutdown.port=9998
     */
    public static final String PLATFORM_SHUTDOWN_PORT_PARAMETER = "openmos.agentplatform.shutdown.port";

    /**
     * Name of the property into the default.properties file that locates the
     * MSB service for recipes deployment. Example:
     * openmos.msb.recipesdeployer.ws.endpoint=http://localhost:9997/wsRecipesDeployer
     */
    public static final String MSB_RECIPESDEPLOYER_WS_PARAMETER = "openmos.msb.recipesdeployer.ws.endpoint";

    /**
     * The shutdown message sent to the agent cloud bootstrap class to start the
    ...
    /**
     * Name of the property into the default.properties file that locates the
     * agent data web-service, e.g. the service that wraps the agent-cloud
     * database repository. The agent data web-service is currently not in use.
     * Example:
     * openmos.agent.data.ws.endpoint=http://localhost:7777/wsAgentDataTest1DAO
     */
    public static final String AGENT_DATA_WS_PARAMETER = "openmos.agent.data.ws.endpoint";

    /**
     * Name of the property into the default.properties file that locates the
     * data cloud web-service, e.g. the service that wraps the tracking
     * repository located somewhere in the cloud. The data cloud web-service is
     * currently not in use. Example:
     * openmos.data.cloud.ws.endpoint=http://localhost:8888/wsDataCloudMessageTracker
     */
    public static final String DATA_SERVICES_WS_PARAMETER = "openmos.data.cloud.ws.endpoint";

    /**
     * Name of the property into the default.properties file that define the
     * logical name of the optimizer to be used. Example:
     * openmos.agent.productionoptimizer.optimization.algorithm.name=ENERGY_OPTIMIZER
     */
    ...
    /**
     * Name of the property into the default.properties file that define the
     * main class name of the optimizer to be used. The class must be located
     * into the agent-cloud java classpath at the platform startup time.
     * Example:
     * openmos.agent.productionoptimizer.optimization.algorithm.class=eu.openmos.energyoptimization.EnergyOptimizer
     */
    ...
    /**
     * Name of the property into the default.properties file that locates the
     * cloud interface web-service, e.g. the entry-point web-service for the
     * platform. This web-service exposes for example calls for agent creation
     * and removal. Example:
     * openmos.agent.systemconfigurator.ws.endpoint=http://localhost:9999/wsSystemConfigurator
     */
    public static final String AGENT_SYSTEMCONFIGURATOR_WS_PARAMETER = "openmos.agent.systemconfigurator.ws.endpoint";

    /**
     * Name of the property into the default.properties file that locates the
     * shutdown web-service, e.g. the service called by the bootstrap class when
     * the user request the shutdown of the entire platform. The service takes
     * care of a clean agents removal before the platform is shutted down.
     * Example:
     * openmos.agent.agentplatformkiller.ws.endpoint=http://localhost:9999/wsAgentPlatformKiller
     */
    ...
    /**
     * It defines the Jade Directory Facilitator service name for the products
     * agent.
     */
    ...
    /**
     * It defines the Jade Directory Facilitator service name for resource
     * agents.
     */
    ...
    //ProductionOptimizer
    /**
     * It defines the Jade Directory Facilitator service name for the production
     * optimizer agent.
     */
    ...
    //SystemOptimizer
    /**
     * It defines the Jade Directory Facilitator type for the system optimizer
     * agent.
     */
    // public static final String DF_SYSTEM_OPTIMIZER = "systemoptimizer_df_service";
    //Cloud Interface Agent
    /**
     * It defines the Jade Directory Facilitator type for the cloud interface
     * agent.
     */
    ...
    //Platform Starter
    /**
     * It defines the Jade Directory Facilitator type for the platform starter
     * agent.
     */
    public static final String DF_PLATFORMSTARTER = "platformstarter_df_service";

    /**
     * It defines the Jade Directory Facilitator service name for the platform
     * starter agent.
     */
    ...
    /**
     * Fully qualified java name of the class implementing the
     * PlatformLauncherAgent.
     */
    ...
    /**
     * It tells the MSB that recipes sent to it are of a "actual" type, e.g.
     * have to be deployed and will be activated.
     */
    ...
    /**
     * It defines messages of type "life beat" for both resource and transport
     * agents, coming from the Manifacturing Service Bus to the agent cloud via
     * p2p communication (websocket).
     */
    public static String MSB_MESSAGE_TYPE_LIFEBEAT = "_MESSAGE_LIFEBEAT_";

    /**
     * It defines messages of type "extracted data" for both resource and
     * transport agents, coming from the Manifacturing Service Bus to the agent
     * cloud via p2p communication (websocket).
     */
    public static String MSB_MESSAGE_TYPE_EXTRACTEDDATA = "_MESSAGE_EXTRACTEDDATA_";

    /**
     * It defines messages of type "new location" for transport agents only,
     * coming from the Manifacturing Service Bus to the agent cloud via p2p
     * communication (websocket).
     */
    public static String MSB_MESSAGE_TYPE_NEWLOCATION = "_MESSAGE_NEWLOCATION_";

    /**
     * It defines messages of type "applied recipes" for resource agents only,
     * coming from the Manifacturing Service Bus to the agent cloud via p2p
     * communication (websocket).
     */
    ...
    /**
     * It defines messages of type "suicide" for both resource and transport
     * agents, coming from the Manifacturing Service Bus to the agent cloud via
     * p2p communication (websocket).
     */
    ...
    /**
     * It defines a category for messages of an unknown type, coming from the
     * Manifacturing Service Bus to the agent cloud via p2p communication
     * (websocket).
     */
