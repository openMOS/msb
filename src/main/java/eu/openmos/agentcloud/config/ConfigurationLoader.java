...
public class ConfigurationLoader
{
  ...
  /**
   * Loads from the classpath the given configuration file, parses values in the form ${parametername}, replacing the
   * ${parametername} with the matching parametervalue.
   *
  ...
  /**
   * Returns the property value corresponding to the property name read from the given configuration file. If the value
   * is in the form ${parametername}, the ${parametername} is replaced with the matching parametervalue taken from the
   * system properties (for the default configuration file) or from the default configuration file (for the other
   * configuration files).
   *
  ...
  /**
   * Returns the property value corresponding to the property name read from the default configuration file. If the
   * value is in the form ${parametername}, the ${parametername} is replaced with the matching parametervalue taken from
   * the system properties (for the default configuration file) or from the default configuration file (for the other
   * configuration files).
   *
   * If the key does not exist or if the value is null it throws an exception.
   *
  ...
  /**
   * Private method for accessing the physical configuration file and bringing it into memory. It doesn't do any
  ...
  /**
   * Given a java Properties object, if any of the values matches the pattern ${parametername}, it replaces the
   * ${parametername} with the "parametervalue" taken from the envConfiguration dictionary. The dictionary can be the
   * java system properties (for the default configuration file) or the default configuration file (for the other
   * configuration files).
   *
   * @param props The java Properties object to do the replacements
   * @param envConfiguration The java system properties (for the default configuration file) or the default
   * configuration file (for the other configuration files)
  ...
  /**
   * Given a single string, if it matches the pattern ${parametername}, it replaces the ${parametername} with the
   * "parametervalue" taken from the envConfiguration dictionary. The dictionary can be the java system properties (for
   * the default configuration file) or the default configuration file (for the other configuration files).
   *
   *
