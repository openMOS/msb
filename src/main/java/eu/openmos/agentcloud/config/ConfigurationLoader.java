...
public class ConfigurationLoader {
    ...
    /**
     * Loads from the classpath the given configuration file, parses values in
     * the form ${parametername}, replacing the ${parametername} with the
     * matching parametervalue.
     *
     * @param configurationFileName The configuration file to be loaded.
     * @return the java Properties object filled with the configuration file
     * content.
     */
    ...
    /**
     * Returns the property value corresponding to the property name read from
     * the given configuration file. If the value is in the form
     * ${parametername}, the ${parametername} is replaced with the matching
     * parametervalue taken from the system properties (for the default
     * configuration file) or from the default configuration file (for the other
     * configuration files).
     *
    ...
    /**
     * Returns the property value corresponding to the property name read from
     * the default configuration file. If the value is in the form
     * ${parametername}, the ${parametername} is replaced with the matching
     * parametervalue taken from the system properties (for the default
     * configuration file) or from the default configuration file (for the other
     * configuration files).
     ...
     * @param configurationFileName The given configuration file
     * @param propertyName The property name to look for
     * @return The value of the matching property, or null if the property
     * doesn't exist.
     */
    ...
    /**
     * Private method for accessing the physical configuration file and bringing
     * it into memory. It doesn't do any ${parametername} replacement.
     *
     * @param configurationFileName The configuration file to be loaded.
     * @return the java Properties object filled with the configuration file
     * content.
    ...
    /**
     * Given a java Properties object, if any of the values matches the pattern
     * ${parametername}, it replaces the ${parametername} with the
     * "parametervalue" taken from the envConfiguration dictionary. The
     * dictionary can be the java system properties (for the default
     * configuration file) or the default configuration file (for the other
     * configuration files).
     *
     * @param props The java Properties object to do the replacements
     * @param envConfiguration The java system properties (for the default
     * configuration file) or the default configuration file (for the other
     * configuration files)
    ...
    /**
     * Given a single string, if it matches the pattern ${parametername}, it
     * replaces the ${parametername} with the "parametervalue" taken from the
     * envConfiguration dictionary. The dictionary can be the java system
     * properties (for the default configuration file) or the default
     ...
     * configuration files).
     *
     * If the key does not exist or if the value is null it returns the
     ...
     * not found
     * @return The value of the matching property, or the defaultValue if the
