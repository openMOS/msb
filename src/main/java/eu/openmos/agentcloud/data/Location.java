...
public abstract class Location {
    ...
    public static int checkLocationType(String location) {
        if(location.contains(eu.openmos.agentcloud.data.utilities.SerializationConstants.TOKEN_PHYSICAL_LOCATION))
            return PHYSICAL_LOCATION;
        if(location.contains(eu.openmos.agentcloud.data.utilities.SerializationConstants.TOKEN_LOGICAL_LOCATION))
