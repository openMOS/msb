...
/**
 * Object that represents the data that product agents receive from the Manufacturing Service Bus (related to products).
 *
...
public class RawProductData
{
  ...
  /**
   * WP3 semantic model alignment. Product instance id.
   */
  private String productId;

  /**
   * WP3 semantic model alignment. Logical location of the product instance.
   */
  private LogicalLocation logicalLocation;

  /**
   * WP3 semantic model alignment. List of recipes.
   */
  private List<Recipe> recipes;

  /**
   * WP3 semantic model alignment. Timestamp of the object.
   */
   ...
   *
   * product instance id, logical location, list of recipes, registeredTimestamp ("yyyy-MM-dd HH:mm:ss.SSS")
   *
