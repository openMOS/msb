...
public class PhysicalLocation extends Location
{
  ...
  /**
   * WP3 semantic model alignment. Location of the product at the given time.
   */
   ...
   *
   * referenceFrameName, x, y, z, alpha, beta, gamma, product instance id, registeredTimestamp ("yyyy-MM-dd
   * HH:mm:ss.SSS")
   *
