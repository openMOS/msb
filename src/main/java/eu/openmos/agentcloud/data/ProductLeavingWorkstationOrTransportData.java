...
/**
 * Object that represents the data that resource or transport agents receive via socket from the Manufacturing Service
 * Bus as soon as the product leaves the workstation or the transport and that then are passed on to the optimizer.
 *
...
public class ProductLeavingWorkstationOrTransportData
{
   ...
   *
   * agentId productId recipeIds registeredTimestamp
   *
