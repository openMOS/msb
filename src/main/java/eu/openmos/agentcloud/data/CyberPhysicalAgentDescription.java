...
/**
 * Describes the agent that arrives to the cloud from the Manufacturing Service
 * Bus to be created.
 *
...
public class CyberPhysicalAgentDescription {
     ...
     * Transport Agent).
     * @param recipes - The recipes the agent can apply (Resource/Transport
     * Agent).
     * @param physicalLocation - The Physical Location of the device abstracted
     * by this agent.
     * @param logicalLocation - The skill requirements of the agent (Product
     * Agent).
