...
/**
 * Object that represents the data that resource agents receive via socket from the Manufacturing Service Bus (related
 * to workstations) and that then are passed on to the optimizer.
 *
...
public class UnexpectedProductData
{
   ...
   *
   * workstationId expectedProductId receivedProductId registeredTimestamp
   *
