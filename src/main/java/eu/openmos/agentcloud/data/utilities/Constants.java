...
public class Constants {
    ...
    public static final String TOKEN_RECIPE = "_";
    ...
    public static final String TOKEN_PRODUCTION_OPTIMIZATION_REQUEST = "+";
    public static final String TOKEN_SKILL = ";";
    public static final String TOKEN_PARAMETER_LIST_ITEM = "?";
    public static final String TOKEN_PRODUCT_DESCRIPTION = "\u00ba";
    public static final String TOKEN_PRODUCTION_OPTIMIZATION_REQUEST_LIST_ITEM = "\u2302";
    ...
    public static final String TOKEN_OPTIMIZATION_PARAMETER = "&";
    public static final String TOKEN_CYBER_PHYSICAL_AGENT_DESCRIPTION = "\u00ab";
    public static final String TOKEN_PARAMETER_SETTING_LIST_ITEM = "#";
    public static final String TOKEN_PARAMETER_SETTING = ":";
