...
public class Product {
    ...
    */
    ...
    /**
     * WP3 semantic model alignment.
     * Timestamp regarding product model.
    */
    ...
    public Product(String modelId, String name, 
            String description, List<Component> components, 
    ...
    */
    public static Product fromString(String object) throws ParseException {
        ...
        List<Component> comps = StringToLists.readComponents(tokenizer.nextToken());       // components
