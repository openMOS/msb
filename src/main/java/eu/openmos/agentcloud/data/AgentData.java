...
/**
 * Object that represents the data the agents receive from the Manufacturing
 * Service Bus and that is then passed to the optimizer.
 * 
 * NOTE: it is not sure if we really need this class or not.
 * For now, we are going to implement RawEquipmentData and RawProductData
 * that should cover what we need.
 * TODO check if this is correct, if we need something else or what....
 * 
