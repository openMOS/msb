...
/**
 * The OptimizationParameter class defines a setup parameter for an optimization algorithm. This class should be used
 * when reparametrizing a custom optimization algorithm through the optimizer agent
...
public class OptimizationParameter
{
  ...
  {
    return name + SerializationConstants.TOKEN_OPTIMIZATION_PARAMETER + type + SerializationConstants.TOKEN_OPTIMIZATION_PARAMETER + unit + SerializationConstants.TOKEN_OPTIMIZATION_PARAMETER + value + SerializationConstants.TOKEN_OPTIMIZATION_PARAMETER + defaultValue;
  }

  /**
   * The fromString method takes a String description, of an OptimizationParameter, created with the toString method on
   * this class and creates the corresponding object
   *
  ...
  {
    StringTokenizer tokenizer = new StringTokenizer(object, SerializationConstants.TOKEN_OPTIMIZATION_PARAMETER);
