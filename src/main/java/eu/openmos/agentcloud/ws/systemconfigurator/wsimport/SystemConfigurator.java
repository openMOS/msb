...
public interface SystemConfigurator
{
   ...
   *
   * @param newOrder
   * @return returns eu.openmos.agentcloud.cloudinterface.OrderStatus
   */
  @WebMethod
  ...
  public OrderStatus acceptNewOrder(
    @WebParam(name = "newOrder", targetNamespace = "") Order newOrder);
  ...
  public AgentStatus removeAgent(
    @WebParam(name = "agentUniqueName", targetNamespace = "") String agentUniqueName);
