...
public class Equipment
{
  ...
  /**
   * WP3 semantic model alignment. Equipment's ID.
   */
  @XmlElement(name = "amlId")
  private String uniqueId;
  /**
   * WP3 semantic model alignment. Equipment's name.
   */
  @XmlElement(name = "name")
  private String name;
  /**
   * WP3 semantic model alignment. Equipment's description.
   */
  private String description;
  /**
   * WP3 semantic model alignment. Equipment execution table.
   *
   * MSB alignment. We will not have an execution table on equipments.
   */
  ...
  /**
   * MSB alignment WP4 semantic model alignment. List of skills!
   */
  private List<Skill> skills;

  /**
   * WP3 semantic model alignment. Equipment timestamp.
   */
...
//    private static final int FIELDS_COUNT = 7;
   ...
   *
   * uniqueId, name, description, execution table, connected, list of skills, registeredTimestamp ("yyyy-MM-dd
   * HH:mm:ss.SSS")
   *
   ...
   *
   * uniqueId, name, description, execution table, connected, registeredTimestamp ("yyyy-MM-dd HH:mm:ss.SSS")
   *
