...
public class ExecutionTable
{
  ...
  /**
   * WP3 semantic model alignment. Execution table unique ID.
   */
  private String uniqueId;
  /**
   * WP3 semantic model alignment. Execution table name.
   */
  private String name;
  /**
   * WP3 semantic model alignment. Execution table description.
   */
  private String description;
  /**
   * WP3 semantic model alignment. List of execution table rows.
   */
  private List<ExecutionTableRow> rows;
  /**
   * WP3 semantic model alignment. Execution table validity timestamp.
   */
   ...
   *
   * uniqueId, name, description, list of execution table rows, registeredTimestamp ("yyyy-MM-dd HH:mm:ss.SSS")
   *
