...
*/
public class CloudInterface_GetSubSystemsTest {
    private static final Logger logger = Logger.getLogger(CloudInterface_GetSubSystemsTest.class.getName());
    
    public static void main(String[] args) {
        logger.info("getSubSystems Test main start");
	...
	SystemConfigurator systemConfigurator = systemConfiguratorService.getSystemConfiguratorImplPort();
        ...
        List<SubSystem> subSystems = systemConfigurator.getSubSystems();
        logger.debug("subSystems list = " + subSystems);
                  
        logger.info("getSubSystems Test main end");
    }
}
