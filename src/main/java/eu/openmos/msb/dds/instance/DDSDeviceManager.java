...
public class DDSDeviceManager implements Runnable {
    ...
    /**
     * Singleton protected constructor for creating the instance This
     * constructor is responsible to obtained the DomainParticipantFactory and
     * create a new participant (DDS Domain)
     *
     * @param domainId
     */
