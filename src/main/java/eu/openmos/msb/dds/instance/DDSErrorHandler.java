...
/**
 * **********************************************************************
 * LOGICAL_NAME: ErrorHandler.java FUNCTION: ErrorHandler class for the
 * HelloWorld OpenSplice programming example. MODULE: OpenSplice HelloWorld
 * example for the java programming language. DATE September 2010.
 * **********************************************************************
 */
import DDS.*;
