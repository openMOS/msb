...
public class DDSDevice {
    ...
    /**
     * DDSDevice constructor. Receives the deviceName and the domain to which
     * will belong
     *
     ...
     * @param query_args A sequence of strings which are the parameter values
     * used in the SQL query string
     *
     * Please refer to the DDS section 3.5.2.2 of the OpenSplice DDS Java
     * Reference Guide for more information about the query conditions
     */
     ...
     * @return 0 if new publisher has been created, 1 if current publisher has
     * been replaced and -1 if an error occurred
     */
     ...
     *
     * @param partition Name of the DDS partition
     * @return 0 if new subscriber has been created, 1 if current subscriber has
     * been replaced and -1 if an error occurred
     */
    ...
    /**
     * Create a new writer, responsible to publish messages at the given topic.
     * A topic with the same name has to be created first!
     *
     * @param topicName Name of the topic
     * @return 0 if the writer was created, 1 if the given topic does not exists
     * and -1 if error
     */
    ...
    /**
     * Create a new reader, responsible to subscribe messages at the given
     * topic. A topic with the same name has to be created first!
     *
     * @param topicName Name of the topic
     * @return 0 if the reader was created, 1 if the given topic does not exists
     * and -1 if error
     */
