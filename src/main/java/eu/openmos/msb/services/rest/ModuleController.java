...
//    private static String PARAMVALUESEPARATOR = "=";
    ...
    @Path(value = "/{moduleId}")
    public Module getDetail(@PathParam("moduleId") String moduleId) {
//        return ModuleTest.getTestObject(moduleId, -1);
        logger.debug("module - getDetail - moduleId = " + moduleId);
...
//            if (subsystem.getName().equals(n[0])) {
   ...
   /**
    ...
    public List<Module> getModulesList(@PathParam("moduleId") String moduleId)
    {
...
//                logger.debug("module - found " + moduleNames[currentModuleNamesIndex]);
   ...
   /**
    ...
    public List<Skill> getSkillsList(@PathParam("moduleId") String moduleId)
    {
        logger.debug("module - getSkillsList - cpadId = " + moduleId);
        logger.debug("module getSkillsList - of the cpad = " + moduleId);
