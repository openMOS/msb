 ...
 */
public class MyTrigonometryMethodManagerListener implements CallableListener {

	private static Logger logger = LoggerFactory.getLogger(MyTrigonometryMethodManagerListener.class);
	 ...
	 */
	public MyTrigonometryMethodManagerListener(UaNode myMethod) {
		super();
